...
def _build_ik_cfg(cfg: Quest3VRTeleopConfig) -> PiperIKConfig:
    return PiperIKConfig(
        ...
        enable_branch_stable_ik=cfg.enable_branch_stable_ik,
        branch_trust_region_rad=tuple(math.radians(value) for value in cfg.branch_trust_region_deg),
...
def make_quest3_vr_robot_action_processor_from_config(cfg: Quest3VRTeleopConfig) -> RobotProcessorPipeline:
    ...
    step = EEToJointIKProcessorStep(
        ...
        enable_branch_stable_ik=cfg.enable_branch_stable_ik,
        branch_target_alphas=cfg.branch_target_alphas,
        commit_accepted_target_only=cfg.commit_accepted_target_only,
